            ...
            <fieldset class="border border-gary p-4 mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            </select><div class="nice-select w-100" tabindex="0"><span class="current">Select category</span><ul class="list"><li data-value="1" class="option selected focus">Select category</li><li data-value="2" class="option">Laptops</li><li data-value="3" class="option">iphone</li><li data-value="4" class="option">microsoft</li><li data-value="5" class="option">monitors</li><li data-value="6" class="option">11inch Macbook Air</li><li data-value="7" class="option">Study Table Combo</li><li data-value="8" class="option">11inch Macbook Air</li><li data-value="9" class="option">Study Table Combo</li><li data-value="10" class="option">11inch Macbook Air</li></ul></div>
                            <div class="price">
